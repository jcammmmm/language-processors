...
def SHW():
  if globals.token.id == 'id':
    match('id')
    SH0()
  elif globals.token.id == 'tk_real' or globals.token.id == 'tk_caracter' or globals.token.id == 'verdadero' or globals.token.id == 'falso' or globals.token.id == 'tk_entero' or globals.token.id == 'tk_cadena':
    LIT()
    SH0()
  elif globals.token.id == 'tk_coma' or globals.token.id == 'tk_mas' or globals.token.id == 'tk_real' or globals.token.id == 'tk_par_der' or globals.token.id == 'tk_mod' or globals.token.id == 'tk_mayor' or globals.token.id == 'tk_menor_igual' or globals.token.id == 'tk_par_izq' or globals.token.id == 'tk_entero' or globals.token.id == 'tk_div' or globals.token.id == 'tk_mult' or globals.token.id == 'tk_menos' or globals.token.id == 'tk_caracter' or globals.token.id == 'verdadero' or globals.token.id == 'falso' or globals.token.id == 'tk_mayor_igual' or globals.token.id == 'tk_cadena' or globals.token.id == 'tk_igual' or globals.token.id == 'tk_menor':
    SH0()
...
def SH0():
  if globals.token.id == 'tk_igual' or globals.token.id == 'tk_menor' or globals.token.id == 'tk_mas' or globals.token.id == 'tk_mod' or globals.token.id == 'tk_mayor' or globals.token.id == 'tk_menor_igual' or globals.token.id == 'tk_mayor_igual' or globals.token.id == 'tk_div' or globals.token.id == 'tk_mult' or globals.token.id == 'tk_menos':
    OPE()
    XPR()
  elif globals.token.id == 'tk_par_izq':
    match('tk_par_izq')
...
def WL1():
  if globals.token.id == 'si':
    ...
    CLA()
    WL1()
  elif globals.token.id == 'cadena' or globals.token.id == 'entero' or globals.token.id == 'booleano' or globals.token.id == 'caracter' or globals.token.id == 'real':
    DCL()
    WL1()
...
def ARG():
  if globals.token.id == 'tk_real' or globals.token.id == 'tk_caracter' or globals.token.id == 'verdadero' or globals.token.id == 'falso' or globals.token.id == 'tk_entero' or globals.token.id == 'tk_cadena':
    LIT()
    AR1()
  elif globals.token.id == 'id':
    match('id')
...
def PRM():
  if globals.token.id == 'cadena' or globals.token.id == 'entero' or globals.token.id == 'booleano' or globals.token.id == 'caracter' or globals.token.id == 'real':
    TYP()
    match('id')
    PRM()
  elif globals.token.id == 'tk_coma':
...
def ATR():
  if globals.token.id == 'cadena' or globals.token.id == 'entero' or globals.token.id == 'id' or globals.token.id == 'booleano' or globals.token.id == 'caracter' or globals.token.id == 'real':
    TPO()
    match('id')
    AT1()
    match('tk_pyc')
...
def CL4():
  if globals.token.id == 'tk_par_izq':
    ...
    ARG()
    match('tk_par_der')
  elif globals.token.id == 'tk_mult' or globals.token.id == 'tk_igual' or globals.token.id == 'tk_menor' or globals.token.id == 'tk_mod' or globals.token.id == 'tk_pyc' or globals.token.id == 'tk_mayor' or globals.token.id == 'tk_menor_igual' or globals.token.id == 'tk_mayor_igual' or globals.token.id == 'tk_div' or globals.token.id == 'tk_mas' or globals.token.id == 'tk_menos':
    XP1()
  else:
    raise SyntacticError(['+', '-', '*', '/', '%', '<', '>', '<=', '>=', '==', ';', '('])
...
def XPR():
  if globals.token.id == 'tk_neg':
    match('tk_neg')
    XPR()
  elif globals.token.id == 'tk_real' or globals.token.id == 'id' or globals.token.id == 'tk_caracter' or globals.token.id == 'verdadero' or globals.token.id == 'falso' or globals.token.id == 'tk_entero' or globals.token.id == 'tk_cadena':
    VAL()
    XP1()
  else:
    raise SyntacticError(['!', 'identificador', 'valor_entero', 'valor_real', 'valor_caracter', 'valor_cadena', 'falso', 'verdadero'])
...
def BLK():
  if globals.token.id == 'retornar':
    ...
    SEL()
    BLK()
  elif globals.token.id == 'caso' or globals.token.id == 'fin_principal' or globals.token.id == 'e' or globals.token.id == 'fin_funcion' or globals.token.id == 'fin_seleccionar' or globals.token.id == 'defecto':
    pass
  else:
