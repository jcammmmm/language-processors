...
def SE1():
  if globals.token.id == 'si':
    ...
    CLA()
    SE1()
  elif globals.token.id == 'cadena' or globals.token.id == 'booleano' or globals.token.id == 'entero' or globals.token.id == 'real' or globals.token.id == 'caracter':
    DCL()
    SE1()
    ...
    s.match('tk_pyc')
    SE1()
  elif globals.token.id == 'e' or globals.token.id == 'defecto' or globals.token.id == 'caso' or globals.token.id == 'fin_seleccionar':
    pass
  else:
...
def SH0():
  if globals.token.id == 'tk_mayor_igual' or globals.token.id == 'tk_menos' or globals.token.id == 'tk_igual' or globals.token.id == 'tk_menor_igual' or globals.token.id == 'tk_dif' or globals.token.id == 'tk_mult' or globals.token.id == 'tk_mas' or globals.token.id == 'tk_mayor' or globals.token.id == 'tk_mod' or globals.token.id == 'tk_menor' or globals.token.id == 'tk_div':
    OPE()
    EXP()
  elif globals.token.id == 'tk_coma' or globals.token.id == 'tk_par_der':
    FIN()
...
def VAL():
  if globals.token.id == 'id':
    s.match('id')
  elif globals.token.id == 'tk_cadena' or globals.token.id == 'tk_entero' or globals.token.id == 'tk_caracter' or globals.token.id == 'falso' or globals.token.id == 'verdadero' or globals.token.id == 'tk_real':
    LIT()
  else:
    raise s.SyntacticError(['identificador', 'valor_entero', 'valor_real', 'valor_caracter', 'valor_cadena', 'falso', 'verdadero'])

def AR2():
  if globals.token.id == 'tk_cadena' or globals.token.id == 'tk_entero' or globals.token.id == 'tk_caracter' or globals.token.id == 'falso' or globals.token.id == 'verdadero' or globals.token.id == 'tk_real':
    LIT()
    AR1()
  elif globals.token.id == 'id':
    s.match('id')
...
def CL4():
  if globals.token.id == 'tk_par_izq':
    ...
    ARG()
    s.match('tk_par_der')
  elif globals.token.id == 'tk_mayor_igual' or globals.token.id == 'tk_menos' or globals.token.id == 'tk_menor' or globals.token.id == 'tk_igual' or globals.token.id == 'tk_pyc' or globals.token.id == 'tk_menor_igual' or globals.token.id == 'tk_mult' or globals.token.id == 'tk_mas' or globals.token.id == 'tk_mayor' or globals.token.id == 'tk_mod' or globals.token.id == 'tk_dif' or globals.token.id == 'tk_div':
    XP1()
  else:
    raise s.SyntacticError(['+', '-', '*', '/', '%', '<', '>', '<=', '>=', '==', '!=', ';', '('])
...
def EXP():
  if globals.token.id == 'tk_cadena' or globals.token.id == 'tk_entero' or globals.token.id == 'id' or globals.token.id == 'tk_caracter' or globals.token.id == 'falso' or globals.token.id == 'verdadero' or globals.token.id == 'tk_real':
    VAL()
    EX1()
  else:
    raise s.SyntacticError(['identificador', 'valor_entero', 'valor_real', 'valor_caracter', 'valor_cadena', 'falso', 'verdadero'])
...
def XPR():
  if globals.token.id == 'tk_neg':
    s.match('tk_neg')
    XPR()
  elif globals.token.id == 'tk_cadena' or globals.token.id == 'tk_entero' or globals.token.id == 'id' or globals.token.id == 'tk_caracter' or globals.token.id == 'falso' or globals.token.id == 'verdadero' or globals.token.id == 'tk_real':
    VAL()
    XP1()
  else:
    raise s.SyntacticError(['!', 'identificador', 'valor_entero', 'valor_real', 'valor_caracter', 'valor_cadena', 'falso', 'verdadero'])
...
def XP1():
  if globals.token.id == 'tk_mayor_igual' or globals.token.id == 'tk_menos' or globals.token.id == 'tk_igual' or globals.token.id == 'tk_menor_igual' or globals.token.id == 'tk_dif' or globals.token.id == 'tk_mult' or globals.token.id == 'tk_mas' or globals.token.id == 'tk_mayor' or globals.token.id == 'tk_mod' or globals.token.id == 'tk_menor' or globals.token.id == 'tk_div':
    ...
    VAL()
    XP1()
  elif globals.token.id == 'tk_par_der' or globals.token.id == 'e' or globals.token.id == 'tk_pyc':
    pass
  else:
    raise s.SyntacticError(['+', '-', '*', '/', '%', '<', '>', '<=', '>=', '==', '!=', ';', ')'])
...
def DO3():
  if globals.token.id == 'booleano' or globals.token.id == 'si' or globals.token.id == 'cadena' or globals.token.id == 'entero' or globals.token.id == 'real' or globals.token.id == 'romper' or globals.token.id == 'mientras' or globals.token.id == 'caracter':
    DO1()
  elif globals.token.id == 'fin_mientras':
    s.match('fin_mientras')
    DO1()
...
def DCL():
  if globals.token.id == 'cadena' or globals.token.id == 'booleano' or globals.token.id == 'entero' or globals.token.id == 'real' or globals.token.id == 'caracter':
    TYP()
    DC3()
  else:
    raise s.SyntacticError(['booleano', 'caracter', 'entero', 'real', 'cadena'])
...
def PRM():
  if globals.token.id == 'cadena' or globals.token.id == 'booleano' or globals.token.id == 'entero' or globals.token.id == 'id' or globals.token.id == 'real' or globals.token.id == 'caracter':
    TIP()
    s.match('id')
    PRM()
  elif globals.token.id == 'tk_coma':
